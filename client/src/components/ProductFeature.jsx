        ...
        <div className="flexCenter gap-x-4 p-2 rounded-3xl">
          ...
          <div>
            ...
            <p>
              ...
              Temporibus, aperiam omnis voluptatem similique quas doloremque
              excepturi veritatis fugit magnam asperiores molestiae ad.
              Accusantium quae cumque tenetur maxime tempora dignissimos
              molestias?
            </p>
          </div>
        </div>
        <div className="flexCenter gap-x-4 p-2 rounded-3xl">
          ...
          <div>
            ...
            <p>
              ...
              atque et molestiae voluptas! Deleniti, doloribus mollitia facere
              dolore eius quia totam deserunt, eaque illum tenetur sed natus
              quos, quis sapiente.
            </p>
          </div>
        </div>
